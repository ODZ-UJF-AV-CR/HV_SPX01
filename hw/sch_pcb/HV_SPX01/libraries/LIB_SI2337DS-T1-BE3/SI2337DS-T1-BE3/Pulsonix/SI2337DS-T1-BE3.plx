...
//14605963/131251/2.50/3/3/MOSFET P-Channel
...
(library Library_1
	...
	(symbolDef "SI2337DS-T1-BE3" (originalName "SI2337DS-T1-BE3")
	...
	(compDef "SI2337DS-T1-BE3" (originalName "SI2337DS-T1-BE3") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SI2337DS-T1-BE3"))
		...
		(attr "Mouser Part Number" "78-SI2337DS-T1-BE3")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Vishay-Siliconix/SI2337DS-T1-BE3?qs=CiayqK2gdcKwfz5JxPKQMQ%3D%3D")
		(attr "Manufacturer_Name" "Vishay")
		(attr "Manufacturer_Part_Number" "SI2337DS-T1-BE3")
		(attr "Description" "MOSFET P-CHANNEL 80-V (D-S)")
		(attr "<Hyperlink>" "https://www.vishay.com/docs/73533/si2337ds.pdf")
		(attr "<Component Height>" "1.12")
		(attr "<STEP Filename>" "SI2337DS-T1-BE3.stp")
